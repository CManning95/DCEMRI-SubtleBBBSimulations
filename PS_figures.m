...
xlim([0 max(PS_range)]);
ylim([-4 4]);
legend({'T_1_0 and DCE corrected','Both uncorrected (k=1.3)','Both uncorrected (k=0.7)'},'Location','best')
legend('boxoff')
...
annotation(figure(1),'textbox',[0.064 0.92 0.05 0.045],'String','a. i','LineStyle','none','FitBoxToText','off','fontweight','bold','FontSize',13);
annotation(figure(1),'textbox',[0.357 0.92 0.06 0.045],'String','a. ii','LineStyle','none','FitBoxToText','off','fontweight','bold','FontSize',13);
annotation(figure(1),'textbox',[0.636 0.92 0.06 0.045],'String','a. iii','LineStyle','none','FitBoxToText','off','fontweight','bold','FontSize',13);
annotation(figure(1),'textbox',[0.064 0.623 0.06 0.045],'String','b. i','LineStyle','none','FitBoxToText','off','fontweight','bold','FontSize',13);
annotation(figure(1),'textbox',[0.357 0.623 0.06 0.045],'String','b. ii','LineStyle','none','FitBoxToText','off','fontweight','bold','FontSize',13);
annotation(figure(1),'textbox',[0.636 0.623 0.06 0.045],'String','b. iii','LineStyle','none','FitBoxToText','off','fontweight','bold','FontSize',13);
annotation(figure(1),'textbox',[0.064 0.322 0.06 0.045],'String','c. i','LineStyle','none','FitBoxToText','off','fontweight','bold','FontSize',13);
annotation(figure(1),'textbox',[0.357 0.322 0.06 0.045],'String','c. ii','LineStyle','none','FitBoxToText','off','fontweight','bold','FontSize',13);
annotation(figure(1),'textbox',[0.636 0.322 0.06 0.045],'String','c. iii','LineStyle','none','FitBoxToText','off','fontweight','bold','FontSize',13);

set(gcf, 'units', 'centimeters','Position', [5 5 28 25]);
set(gcf, 'units', 'centimeters','PaperPosition', [0 0 28 25]);    % can be bigger than screen 
