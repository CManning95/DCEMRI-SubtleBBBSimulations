...
switch SimParam.InjectionRate
    ...
    case 'slow' % use slow injection AIF from patient data to generate 'slow' injection
        ...
        Cp_AIF_mM(1:(3.5/SimParam.InputAIFDCENFrames)*size(initial_timepoints_full_s)) = 0; %Set all pre-contrast points to zero (as interpolation produces non-zero pre contrast values)
