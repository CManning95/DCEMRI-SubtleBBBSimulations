...
Cp_AIF_sample_mM = (1/(1-PhysParam.Hct))*DCEFunc_Enh2Conc_SPGR(enh_AIF_sample_pct,PhysParam.T1_blood_meas_s,SeqParam.TR_s,SeqParam.TE_s,SeqParam.FA_meas_deg,SeqParam.r1_per_mM_per_s,SeqParam.r2_per_mM_per_s);
for i = 1:size(enh_tissue_sample_pct,2)
    Ct_sample_mM(:,i) = DCEFunc_Enh2Conc_SPGR(enh_tissue_sample_pct(:,i),PhysParam.T1_tissue_meas_s,SeqParam.TR_s,SeqParam.TE_s,SeqParam.FA_meas_deg,SeqParam.r1_per_mM_per_s,SeqParam.r2_per_mM_per_s); 
end
